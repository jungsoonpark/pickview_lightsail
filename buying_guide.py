            ...
            messages=[
                {
                    ...
                    "content": f"당신은 매우 경험이 풍부한 블로거입니다. 아래와 같은 정보들을 바탕으로 {keyword}에 대한 구매 가이드를 작성해주세요.\n\n"
                               ...
                               "2. 구매 전 체크리스트: 구매 전 확인해야 할 중요한 항목을 200자 내외로 설명해 주세요. 사용자의 불편함을 피할 수 있는 팁도 추가해 주세요.\n"
                               "3. 자주 묻는 질문: 이 상품을 구매하기 전에 자주 묻는 질문에 대해 300자 내외로 답변해 주세요. 가장 일반적인 궁금증을 포함시켜 주세요.\n"
                               "글은 블로그 스타일로, **친근하고 쉽게 이해할 수 있는 말투**로 작성해 주세요. 마치 독자에게 직접 이야기하는 느낌으로 작성해주세요. 리뷰를 바탕으로, 고객들이 궁금해할만한 사항도 함께 작성해 주세요.\n"
                               f"키워드: {keyword}"
                }
            ],
            timeout=30
